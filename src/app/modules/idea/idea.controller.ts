...
const getAllIdeas = catchAsyncHandler(async (req: Request, res: Response) => {
  const result = await ideaService.getAllIdeas(req.query as any);
  return sendResponse(res, {
    httpStatusCode: status.OK,
    success: true,
...
const getMyIdeas = catchAsyncHandler(async (req: Request, res: Response) => {
  const result = await ideaService.getMyIdeas(req.user, req.query as any);
  return sendResponse(res, {
    httpStatusCode: status.OK,
    success: true,
...
const getAllIdeasAdmin = catchAsyncHandler(
  async (req: Request, res: Response) => {
    const result = await ideaService.getAllIdeasAdmin(req.query as any);
    return sendResponse(res, {
      httpStatusCode: status.OK,
      success: true,
